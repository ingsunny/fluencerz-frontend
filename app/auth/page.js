...
export default function AuthPage() {
    ...
    // Parse URL hash to set initial mode and user type
    useEffect(() => {
    ...
    // Update URL hash when toggling login/register or user type
            ...
            <XMarkIcon className="w-6 h-6" />
                    ...
                    <div className="flex justify-center gap-4 mb-6">
                        <button
                            ...
                            className={`px-6 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${isLogin
                    ...
                    <h1 className='mt-10 font-bold'>Complete Your Profile:</h1>
                    <p>Once you fill in the required information, 
                        your profile will be visible on our dashboard. This allows our clients to
                         easily discover and select your profile for upcoming campaigns. Make sure everything
                          is up to date for the best chances of getting noticed!</p>
